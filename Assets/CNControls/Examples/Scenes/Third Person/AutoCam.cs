...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_RollSpeed = 0.3f;// How fast the rig will roll (around Z axis) to match target's roll.
        [SerializeField] private bool m_FollowVelocity = false;// Whether the rig will rotate in the direction of the target's velocity.
        [SerializeField] private bool m_FollowTilt = false; // Whether the rig will tilt (around X axis) with the target.
        ...
        [SerializeField] private float m_TargetVelocityLowerLimit = 1f;// the minimum velocity above which the camera turns towards the object's velocity. Below this we use the object's forward direction.
